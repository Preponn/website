    ...
    <div class="container mt-3">
        <div class="row justify-content-center">
            <div class="col-md-6 p-3">
                <h1 class="pon-blue-bg text-white py-3 px-2">Book a free session for {{ course }}</h1>
                <h4 class="mb-3 pon-blue">Fill up this form. We will get in touch with you.</h4>
                <form method="POST" action="https://script.google.com/macros/s/AKfycbzvMdLTpFCixh1znIrcoMYmvLcdQTt8vHpFTo1QPU3YGRySkDhyMsUap6uoq5tKoCqd/exec">
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn pon-btn" @click="freeSession" :class="{'disabled' : loading}">{{ loading ? "Please Wait..." : "Submit" }}</button>
                </form>
            </div>
        </div>
    </div>
        ...
        methods : {
            freeSession(e){
                ...
                // }).then(() => {
                    ...
                    this.loading = true
                    fetch('https://script.google.com/macros/s/AKfycbzvMdLTpFCixh1znIrcoMYmvLcdQTt8vHpFTo1QPU3YGRySkDhyMsUap6uoq5tKoCqd/exec', {
                        method: 'POST',
