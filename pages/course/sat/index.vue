            ...
            <div class="row justify-content-center mt-2">
                ...
                <div class="col-3 d-none d-md-block border">
                    ...
                    <p class="px-2 fw-bold fs-italic" style="text-align:justify;">
                        We take our PSAT and SAT students seriously. This is because we understand
                        just how important this first step, in your life, happens to be. Even when we are
                        mentoring our younge students, sometimes aged as young as 11-year-old, we
                        ensure that we help shape a structured mindset that can be easily receptive to
                ...
                <div class="col-12 col-md-9">
                    ...
                    <div class="p-2 border">
                        ...
                        <ul>
                            <li>
                                Diagnostic test after every 15 Days
                            </li>
                            <li>
                                2100+ Questions in Question Bank Study Portal for 3 Months
                            </li>
                            <li>
                                3 Classes per week
                            </li>
                    ...
                    <div class="p-2 mt-3 border">
                        ...
                        <ul>
                            ...
                            <li>
                                2100+ Questions in Question Bank Study Portal for 6 Months
                            </li>
                            <li>
                                Unlimited doubt sessions before actual test
                            </li>
                            <li>
                                4 Classes per week
                            </li>
