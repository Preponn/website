        ...
        <div class="container-fluid">
            <div class="row reg-btn-div justify-content-center py-2 bg-dark text-center">
                <div id="reg-btn" class="col text-white fw-bold">
                    <NuxtLink to="/course/gre/register" class="text-white heading text-decoration-none p-1 rounded-0 me-2">Register Now</NuxtLink>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <p class="text-justify lh-4 px-3">
                        ...
                        recommend learning a quarter of a million words from the dictionary. We employed the
                        best-practices from the industry to devise a variety of fun tool-based approaches, respecting
                    ...
                    <p class="text-justify lh-4 px-3">
                        ...
                        questions by yourself, using information from the passage, without looking at the answer
                    ...
                    <p class="text-justify lh-4 px-3">
                        ...
                        process of effectively working with an Error Log, so you may learn the art of objectively looking
                        for the credited responses, while eliminating incorrect answer choices using trap words, on sight
